...
// Howard Community College grading scale (no +/-)
const GRADE_OPTIONS = [
  { label: "A", value: "4.0_A" },
  { label: "B", value: "3.0_B" },
  { label: "C", value: "2.0_C" },
...
export default function HowardGpaCalculatorClient() {
  ...
  const calculate = () => {
    ...
    const sgpa = round2(semPoints / semCredits);
    ...
    <>
            ...
            <CardContent className="p-5">
              ...
              {showNames && (
                <div className="mb-3">
                  ...
                  <Input
                    type="text"
                    placeholder="e.g. ENGL 121 College Composition"
                    value={course.name}
              ...
              <div className="mt-6 text-left">
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-lg bg-muted/50 p-3 text-sm font-medium">
                    Total Credits: {result.totalCredits} · Quality Points: {result.totalPoints.toFixed(2)}
                  </div>
                </div>
              </div>
            )}
      ...
      <Card className="mt-10">
        <CardContent className="p-6">
          <h2 className="text-lg font-bold mb-4 font-heading">HCC Grading Scale</h2>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Based on the official Howard Community College grading system. Letter grades A, B, C, D, F, and FW earn quality points per credit hour. Grades of W, I, L, NA, and N are not used in computing the GPA.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mt-6">
        <CardContent className="p-6">
          <h2 className="text-lg font-bold mb-4 font-heading">About the Howard GPA Calculator</h2>
          <p className="text-sm text-muted-foreground">
            Howard Community College uses a straightforward 4.0 GPA scale where A = 4, B = 3, C = 2, D = 1, and F/FW = 0 quality points per credit hour. HCC does not use plus or minus grades. This calculator follows the official HCC grading system so you can quickly project your semester GPA and roll it into your cumulative GPA.
          </p>
          <p className="mt-3 text-sm text-muted-foreground">
            Keep in mind that grades of W (Withdraw), I (Incomplete), L (developmental), NA (Never Attended), and N (Audit) do not carry quality points and are excluded from GPA computation. The highest grade earned in a repeated course will count toward the GPA.
          </p>
          <p className="mt-3 text-sm text-muted-foreground">
